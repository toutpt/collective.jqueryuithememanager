...
from collective.jqueryuithememanager.tests import layer
from collective.jqueryuithememanager.tests import utils
...
#        from collective.jqueryuithememanager.interfaces import IJQueryUIThemeManagerLayer
#        super(UnitTestCase, self).setUp()
#        self.context = utils.FakeContext()
#        self.request = Request()
#        interface.alsoProvides(self.request,
#                               (IAttributeAnnotatable,IJQueryUIThemeManagerLayer))
